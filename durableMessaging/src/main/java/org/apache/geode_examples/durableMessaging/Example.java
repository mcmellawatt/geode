...
public class Example {
  ...
  public static void main(String[] args) throws Exception {
    ...
    Region<Integer, String> exampleClientRegionOne =
        clientOneRegionFactory.create("example-region");
    ...
    Region<Integer, String> exampleClientRegionTwo =
        clientTwoRegionFactory.create("example-region");
    ...
    clientOneRegionFactory =
        clientCacheOne.createClientRegionFactory(ClientRegionShortcut.CACHING_PROXY);
    exampleClientRegionOne = clientOneRegionFactory
        .addCacheListener(new ExampleCacheListener<Integer, String>()).create("example-region");
