...
public class CacheClientNotifierIntegrationTest {
  @Test
  public void NotifyClientsWithClientUpdateMessage() {
    ...
    List overflowAttributesList = mock(List.class);

    CacheClientNotifier cacheClientNotifier = CacheClientNotifier.getInstance(cache, cacheServerStats, 10, 10, connectionListener, overflowAttributesList, false);

    InternalCacheEvent internalCacheEvent = mock(InternalCacheEvent.class);
    ClientUpdateMessage clientUpdateMessage = mock(ClientUpdateMessage.class);
